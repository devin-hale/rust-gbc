...
impl CPU {
    ...
    fn handle_sla(&mut self, r: instr::Register) {
    ...
    fn handle_sra(&mut self, r: instr::Register) {
        let v = self.src_register(r).unwrap() as u8;
        let v0 = bit::get(v, 0);
    ...
    fn handle_swap(&mut self, r: instr::Register) {
        let v = self.src_register(r).unwrap() as u8;
        let l = (v & 0b1111) << 4;
    ...
    fn handle_res(&mut self, r: instr::Register, b: u8) {
...
mod test {
    ...
    fn test_sub_a_r() {
        ...
        // sub A, N
        run_json_test(String::from("d6.json"));
    }
    ...
    fn test_cp_a_r() {
        ...
        // CP A, N
        run_json_test(String::from("fe.json"));
    }
    ...
    fn test_dec_rr() {
        for i in 0..=3u8 {
            run_json_test(format!("{i:x}b.json"));
        }
    }
    ...
    #[test]
    fn test_ffc_a() {
        run_json_test(String::from("e2.json"));
    }
    ...
    #[test]
    fn test_jp_hl() {
        run_json_test(String::from("e9.json"));
    }
    ...
    fn test_sla_r() {
        // SLA R
        for i in 0..=7u8 {
            run_json_test(format!("cb 2{i:x}.json"))
        }
    }
